...
icacls %systemroot%\systemresources /grant:r Àäìèíèñòðàòîðû:F >nul
takeown /f %systemroot%\systemresources\imageres.dll.mun >nul
icacls %systemroot%\systemresources\imageres.dll.mun /grant:r Àäìèíèñòðàòîðû:F >nul
takeown /f %systemroot%\systemresources\imagesp1.dll.mun >nul
icacls %systemroot%\systemresources\imagesp1.dll.mun /grant:r Àäìèíèñòðàòîðû:F >nul
takeown /f %systemroot%\systemresources\shell32.dll.mun >nul
icacls %systemroot%\systemresources\shell32.dll.mun /grant:r Àäìèíèñòðàòîðû:F >nul
chcp 866 >nul
goto tango_patcher
:lang_en
chcp 866 >nul
